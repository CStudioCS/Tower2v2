...
public partial class @PlayerActionsAsset: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerActionsAsset()
    {
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PlayerActionsAsset.Player.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, PlayerActionsAsset.UI.Disable() has not been called.");
    }
